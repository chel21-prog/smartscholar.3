...
const st = {
  ...
  modalHead:   { display:"flex", justifyContent:"space-between", alignItems:"center", padding:"16px 22px", borderBottom:"1px solid var(--border)", flexShrink:0 },
...
export default function CoordinatorDashboard() {
  ...
  // right back to the page they came from instead of stranding them
  // on the Dashboard.
  useEffect(() => {
  ...
  const closeReportModal = () => {
    ...
    if (reportReturnTo) {
      const dest = reportReturnTo;
      setReportReturnTo(null);
      navigate(dest);
    }
  };
